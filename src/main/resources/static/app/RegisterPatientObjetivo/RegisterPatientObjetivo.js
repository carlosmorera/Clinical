...
, "nombreObjetivo":$scope.objetivoSelected.nombre
            ...
            .$promise.then(
                    ...
                    function( value ){
                        $scope.personT=value;
                        var x= true ;
                        for (var i = 0; i < $scope.personT.objetivoscurriculums.length; i++) { 
                                        if($scope.personT.objetivoscurriculums[i].nombreObjetivo==$scope.nuevoObjetivo.nombreObjetivo){
                                            x = false;
                                        }
                                    }
                        console.info(x);
                       if ( x === true){ 
                              ...
                              $scope.personT.objetivoscurriculums.push($scope.nuevoObjetivo);
                              console.info($scope.nuevoObjetivo);
