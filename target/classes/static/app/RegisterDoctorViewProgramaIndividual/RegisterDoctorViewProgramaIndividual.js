                            ...
                            .$promise.then(
                                    //success
                                            function (value) {
                                                ...
                                                var copy = $scope.diagnostics;
                                                for (var i = 0; i < $scope.diagnostics.length; i++) {
                                                    var max = $scope.diagnostics[i];
                                                    for (var j = i + 1; j < $scope.diagnostics.length; j++) {
                                                        var ob = $scope.diagnostics[j];
                                                        if (max.area == ob.area &&
                                                                max.subarea == ob.subarea &&
                                                                max.nombreObjetivo == ob.nombreObjetivo &&
                                                                max.date == ob.date) {
                                                            if (max.objetivoId < ob.objetivoId) {
                                                                var index = copy.indexOf(max);
                                                            } else {
                                                                var index = copy.indexOf(ob);
                                                            }
                                                ...
                                                for (var i = 0; i < copy.length; i++) {
                                                    $scope.diagnosticsNew.push(copy[i]);
                                                }
                                        ...
                                        .$promise.then(
                                                //success
                                                        function (value) {
                                                            ...
                                                            $scope.objetivosC = $scope.personaC.objetivoscurriculums;
                                                            $scope.objetivos = [];
                                                                        ...
                                                                        .$promise.then(
                                                                                //success
                                                                                        function (value) {
                                                                                            ...
                                                                                            $scope.objetivosT = $scope.personT.objetivoscurriculums;
                                                                                            for (var l = 0; l < $scope.objetivosT.length; l++) {
                                                                                                if ($scope.objetivosT[l].nombreObjetivo == $scope.objetivoSelected.nombre) {
                                                                                                    var res = false;
                                                                                                    var punts = $scope.objetivosT[l].puntuacionescuatrimestrals;
                                                                                                    ...
                                                                                                    if (res == false) {
                                                                                                        $scope.objetivosT[l].puntuacionescuatrimestrals.push($scope.diagnostic);
                                                                                                    }
